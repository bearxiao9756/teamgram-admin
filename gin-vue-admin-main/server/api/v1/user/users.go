...
// @Param data body user.Users true "创建users表"
...
// @Accept application/json
// @Produce application/json
// @Param data body user.Users true "删除users表"
...
func (usersApi *UsersApi) DeleteUsers(c *gin.Context) {
	...
	id := c.Query("id")
	err := usersService.DeleteUsers(ctx,id)
	if err != nil {
...
func (usersApi *UsersApi) DeleteUsersByIds(c *gin.Context) {
	...
	err := usersService.DeleteUsersByIds(ctx,ids)
	if err != nil {
...
// @Accept application/json
// @Produce application/json
// @Param id query int true "用id查询users表"
// @Success 200 {object} response.Response{data=user.Users,msg=string} "查询成功"
